...
const EXT_UPD = { sourceId: 'test-fa-src-1', origin: 'external_import', entityHash: 'aa'.repeat(32), importHash: 'bb'.repeat(32), importedFields: ['tag', 'title', 'body'], importUpdatedAt: '2026-08-05T10:00:00.000Z', sourceVersion: { sequence: 4, modifiedAt: '2026-08-05T09:00:00.000Z', revisionId: 'TEST-FA-REVTOKEN-1' }, normalizerVersion: 1, revisions: [{ at: '2026-08-05T10:00:00.000Z', packageHash: 'cc'.repeat(32), sessionRef: 'TEST-FA-REV-S1', prevEntityHash: 'dd'.repeat(32), entityHash: 'aa'.repeat(32), updatedFields: ['body'], mode: 'update' }], localResolutions: [{ entityHash: 'ee'.repeat(32), packageHash: 'ff'.repeat(32), resolvedAt: '2026-08-06T10:00:00.000Z' }] };
const CONNS = [
  {
