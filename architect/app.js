...
const DEFAULT_CFG = {
  ...
  weekFocuses: [
    {t:'Глава 7 — найти первого свидетеля', c:'var(--blue-btn)'},
    {t:'Check-in каждое утро',               c:'var(--green)'},
    {t:'Паттерн: волновая природа энергии',  c:'var(--orange)'},
  ],
};
...
const DEFAULT_DB = {
  insights: [
    {id:1, tag:'book', w:4, title:'Архетип паука — шаманская смерть', body:'Видение паука — архетип трансформации через разрушение. Камалока у Блаватской, испытание у Кардека, архонты у гностиков. Паук не разрушает — он прядёт новую форму.', date:'18 июн', src:'Сессия с Claude', links:[]},
    {id:2, tag:'book', w:3, title:'Сон — сначала переживание, потом смысл', body:'Правило: что произошло → что ощущалось в теле → тон. Трактовка через личный резонанс, не через словарные символы.', date:'18 июн', src:'Мастер-промт', links:[]},
    {id:3, tag:'bot',  w:2, title:'Фильтр токсичных чатов', body:'Добавить проверку таблицы blocked_chats перед отправкой комментария. Хранить в PostgreSQL с полем reason.', date:'17 июн', src:'@belkovsongbot', links:[]},
    {id:4, tag:'pattern', w:5, title:'Бессознательное убирает зависимости последовательно', body:'Паттерн: Виолетта → вейп → ? Первая остановка через внутренний сигнал, не через волевое усилие.', date:'18 июн', src:'Vitality', links:[]},
    {id:5, tag:'personal', w:4, title:'Осознанное сновидение — опыт наблюдателя', body:'Наблюдать себя во сне — прямая связь с ведическим Атманом. Не нуждается в оправдании через внешние источники.', date:'16 июн', src:'Личный опыт', links:[]},
  ],
  dreams: [
    {id:1, date:'18 июн 2026', title:'Родовое собрание', body:'Зал. Люди из разных эпох жизни. Отец в углу — молчит. Нужно что-то решить, но вопрос не произносится вслух. Тело тяжёлое.', tone:'тяжело', arch:'Тень / Род / Отец'},
    {id:2, date:'14 июн 2026', title:'Арматура', body:'Строительный объект. Кто-то протягивает арматуру. Отказываюсь взять. Ощущение — это чужое оружие или чужая защита.', tone:'тревожно', arch:'Анима / Защита'},
  ],
  patterns: [
    {id:1, type:'Поведенческий', text:'Цикл: погружение → насыщение → пауза → новое погружение. Это не сбой дисциплины — это режим системы.', cnt:3},
    {id:2, type:'Отношенческий', text:'Уход когда становится слишком близко. Граница возникает из страха утраты себя.', cnt:4},
    {id:3, type:'Творческий',    text:'Лучший текст — в состоянии между усилием и отпусканием. Не форсировать. Не ждать вдохновения.', cnt:3},
    {id:4, type:'Телесный',      text:'Никотин как заземление при тревоге. Рука тянется когда нужна пауза между задачами.', cnt:5},
  ],
  evolution: [
    {id:1, lv:3, text:'Принято: волновая природа энергии — не патология. Это режим.', dt:'18 июн 2026'},
    {id:2, lv:2, text:'Почувствована разница между анализом из ясности и анализом из тревоги. Vitality — фундамент.', dt:'16 июн 2026'},
    {id:3, lv:1, text:'Карта личности — навигационный инструмент, не описание человека.', dt:'10 июн 2026'},
    {id:4, lv:3, text:'Структура 3 томов / 24 глав зафиксирована. Эталон тона — главы 20–23.', dt:'1 мар 2026'},
  ],
  spiritual: [
    {id:1, type:'Осознанное сновидение', date:'14 июн 2026', text:'Момент осознания внутри сна. Наблюдатель стал видимым для себя. Атман — не теория, а опыт.'},
    {id:2, type:'Медитация', date:'10 июн 2026', text:'30 минут тишины после прогулки. Ясность 9/10. В этом состоянии стратегические решения приходят сами.'},
    {id:3, type:'Синхроничность', date:'5 июн 2026', text:'Три человека в один день упомянули тему рода. Разговор с сестрой, подкаст, сон.'},
  ],
  checkins: [],
  bots: [
    {id:1, title:'Фильтр токсичных чатов в автокомментинге', prio:'high', done:false},
    {id:2, title:'Подключить все handlers к Router', prio:'high', done:false},
    {id:3, title:'Business-воронка: CRM follow-up', prio:'med', done:false},
    {id:4, title:'Bio ротация раз в неделю', prio:'med', done:false},
    {id:5, title:'Webhook автосохранения инсайтов', prio:'med', done:false},
  ],
  chapters: [
    {n:1,  title:'Вводная',         st:'done',     flags:[]},
    {n:2,  title:'Первые свидетели', st:'wip',      flags:[]},
    {n:7,  title:'Сны и реальность', st:'priority', flags:['0 свидетелей']},
    {n:9,  title:'Путь через тело',  st:'done',     flags:[]},
    {n:17, title:'Встреча с отцом',  st:'wip',      flags:['узловая']},
    {n:20, title:'Эталон тона',      st:'done',     flags:['эталон']},
    {n:21, title:'Эталон тона',      st:'done',     flags:['эталон']},
    {n:22, title:'Паук',             st:'priority', flags:['архетип']},
    {n:23, title:'Эталон тона',      st:'done',     flags:['эталон']},
    {n:24, title:'Синтез',           st:'todo',     flags:['особое внимание']},
  ],
  digests: [
    {id:1, week:'10–16 июня 2026', h:'Архетип паука и интеграция Skills', cnt:8, themes:['Книга','Паук','Skills','Архетипы']},
    {id:2, week:'3–9 июня 2026',   h:'Промт книги v2 и структура 24 глав', cnt:11, themes:['Промт','Архитектура','МакКи','Голос']},
  ],
  oq: [
    'От чьей арматуры ты до сих пор защищаешься?',
    'Умеешь ли ты создавать резонанс — или только узнавать когда он уже есть?',
    'Что было скрытым в семейной системе?',
    'Глава 7: почему ноль свидетелей — пробел или решение?',
  ],
